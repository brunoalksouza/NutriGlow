          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Responda algumas perguntas rápidas e receba seu plano alimentar personalizado criado pela Grok, nossa IA
                nutricional.
              </p>
            </div>
              ...
              <Card className="border-purple-200 bg-white/70 backdrop-blur-sm">
                <CardContent className="p-4 flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Powered by Grok AI</p>
                  </div>
                </CardContent>
              </Card>
